...
class MockUserService {
    constructor() {
        this.mockUserCode = { code: "Neo", display: "Neo" };
    }
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.6", ngImport: i0, type: MockUserService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.2.6", ngImport: i0, type: MockUserService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.6", ngImport: i0, type: MockUserService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
class NewsInfoComponent {
    constructor() {
        ...
        this.mockUserService = inject(MockUserService);
        this.#jetStreamWsService = inject(JetstreamWsService);
...
export { NewsInfoComponent, NewsListComponent, NewsService, UserNews, UserProfile };
